...
- `play-dev-header.*` – Google Play developer page header, 4096x2304 (16:9). Same design as the feature graphic, English only; rendered at 4x device scale from a 1024x576 page.
